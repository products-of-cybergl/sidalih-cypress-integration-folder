...
describe('Tambah Program di Pagu', () => {
    ...
    it('Menambah', () => {
        ...
        cy.get('[data-test=input-kode]').type('01', { delay: 200 })

        cy.get('[data-test=input-nama]').type('Program Penggemukan Fathur', { delay: 100 })
        ...
        cy.get('[data-test=search-box-program]').type('Fathur', { delay: 200 })
